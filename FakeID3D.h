...
class FakeID3DInterface7
{
public:
	virtual LPDIRECT3D7 getAsDirect3D() = 0;
};

class FakeID3DVertexBufferInterface7
{
public:
	virtual LPDIRECT3DVERTEXBUFFER7 getAsDirect3DVertexBuffer() = 0;
};

class FakeID3DDeviceInterface7
{
public:
	virtual LPDIRECT3DDEVICE7 getAsDirect3DDevice() = 0;
};

class FakeID3D7 : public IDirect3D7, public FakeID3DInterface7
{
public:
	...
	virtual LPDIRECT3D7 getAsDirect3D()
	{
		return m_pID3D;
	}
...
class FakeID3DVertexBuffer7 : public IDirect3DVertexBuffer7, public FakeID3DVertexBufferInterface7
{
public:
...
class FakeID3DDevice7: public IDirect3DDevice7, public FakeID3DDeviceInterface7
{
public:
	...
	virtual LPDIRECT3DDEVICE7 getAsDirect3DDevice()
	{
		return m_pID3DDevice;
	}	
